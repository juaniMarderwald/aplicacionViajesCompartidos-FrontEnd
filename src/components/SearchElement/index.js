...
import { Elemento, FloatingDivPasajeros, SearchButton, SearchCantidadPasajeros, SearchCiudad, SearchElementContainer, SearchFecha } from './style';
        ...
        <Fragment>
            <SearchElementContainer>
                ...
                <FloatingDivPasajeros show={showFloatingDiv}>
                    <ContainerCantidadPasajeros pasajeros={numeroPasajeros} setPasajeros={setNumeroPasajeros} />
